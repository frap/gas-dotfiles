...
*** Winner mode
  ...
  between windows configurations.
...
** Controlling Window Size
   ...
   #+BEGIN_SRC elisp
     ...
     (global-set-key (kbd "C-c w r") 'gas/window-standard-size)
   #+END_SRC
   ...
   #+BEGIN_SRC elisp
     (defun gas/window-standard-size (arg)
...
** Helm
   ...
   #+BEGIN_SRC elisp
     (use-package helm
       ...
       )   ;; Binds C-x c to the helm bidness.
   #+END_SRC
